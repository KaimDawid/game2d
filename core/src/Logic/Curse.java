...
import static com.mygdx.game.Assets.csTXT;
...
public class Curse {
    ...
    public static void Rogue(Player player){
        player.setRogue(1);
        player.setMagic(-500);
        GameApp.curseTEXT = "You have obtained the Rogue curse, \n you attack twice, \n" +
    ...
    public static void GlassCannon(Player player){
        ...
        GameApp.curseTEXT = "You have obtained the Fragile curse, \n your physical damage is increased greatly, \n" +
    ...
    public static void Decay(Player player){
        player.setDecay(1);
        GameApp.curseTEXT = "You have obtained the Decay curse, \n you heal for more, \n" +
