    ...
    public static void SPAWN(int mobsNumber, Monster[] monsterBase) {
        ...
        for (int i = 0; i < mobsNumber; i++) {
            ...
            if (valid < 1) {
                ...
                if (mobType < 21) {
                    monsterBase[i] = new Mutant(400, 70, valueX, valueY, "mutant", 120, 60, 6, 5);
                } else if (mobType < 41 && mobType > 20) {
                    monsterBase[i] = new Imp(240, 50, valueX, valueY, "imp", 80, 20, 5, 5);
                }
                //
                //        Tu ustawiasz szansę na pojawienie się danego typu przeciwnika
                //
                else if (mobType < 61 && mobType > 40) {
                    monsterBase[i] = new Skeleton(300, 50, valueX, valueY, "szkielet", 100, 20, 5, 5);
                } else if (mobType < 81 && mobType > 60) {
                    monsterBase[i] = new Vampire(500, 70, valueX, valueY, "elite wampir", 160, 50, 3,5 );
                }
                else if (mobType > 80){
                    monsterBase[i] = new Mutant(600, 90, valueX, valueY, "elite mutant", 200, 70, 5, 5);
                }
