...
int GC;
    ...
    public void Freeze(Monster target) {
        ...
        if (stun <1) {
            ...
            Fonts.playerAttackText = "You are stunned for " + stun + " turns";
        }
    }
        ...
        if (stun  < 1) {
            ...
            if (fearValue < 51) {
                if (roll > critRoll) {
                    ...
                    Autoattack.criticalAttack = true;
